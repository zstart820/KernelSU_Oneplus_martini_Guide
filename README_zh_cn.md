...
| ~~Pixel OS~~(已废弃) | ~~[bheatleyyy/kernel_oplus_sm8350](https://github.com/bheatleyyy/kernel_oplus_sm8350.git)~~ | ~~thirteen~~ | ~~[bheatleyyy](https://github.com/bheatleyyy/kernel_oplus_sm8350.git)~~ | ~~需要刷入vendor_dlkm.img。必须使用基于OOS-13的PixelOS版本。~~ |
